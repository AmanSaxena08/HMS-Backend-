...
urlpatterns = [
    ...
    path('patients/<str:uhid>/admissions/<str:adm_no>/lab-reports/', LabReportListCreateView.as_view(), name='lab-reports'),
    path('patients/<str:uhid>/admissions/<str:adm_no>/lab-report-templates/', LabReportTemplateSuggestionsAPIView.as_view(), name='lab-report-templates'),
